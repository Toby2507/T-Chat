...
import { useSetProfilePictureMutation } from './groupChatSlice';
...
const SetGroupProfilePicture = ({ groupId, currentImg, setChangePP }: setGPPInterface) => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      await setPP({ groupId, formData }).unwrap();
