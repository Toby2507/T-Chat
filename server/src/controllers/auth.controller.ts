...
export const createUserHandler = async (req: Request<{}, {}, createUserInput>, res: Response) => {
    ...
    try {
        ...
        res.cookie('jwt', refreshToken, { httpOnly: true, sameSite: 'lax', secure: true, maxAge: 24 * 60 * 60 * 1000, path: "https://tobychat.netlify.app" });
...
export const logoutUserHandler = async (req: Request, res: Response) => {
    ...
    res.clearCookie('jwt', { httpOnly: true, sameSite: 'lax', secure: true, path: "https://tobychat.netlify.app" });
