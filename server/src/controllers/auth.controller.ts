...
export const createUserHandler = async (req: Request<{}, {}, createUserInput>, res: Response) => {
    ...
    try {
        ...
        res.cookie('jwt', refreshToken, { httpOnly: true, sameSite: 'lax', secure: true, maxAge: 24 * 60 * 60 * 1000, domain: "https://tobychat.netlify.app" });
...
export const logoutUserHandler = async (req: Request, res: Response) => {
    ...
    res.clearCookie('jwt', { httpOnly: true, sameSite: 'lax', secure: true, domain: "https://tobychat.netlify.app" });
