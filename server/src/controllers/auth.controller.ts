...
export const createUserHandler = async (req: Request<{}, {}, createUserInput>, res: Response) => {
    ...
    try {
        ...
        res.cookie('jwt', refreshToken, { httpOnly: true, sameSite: 'none', secure: true, maxAge: 24 * 60 * 60 * 1000, domain: "tobychat.netlify.app", path: "/" });
...
export const logoutUserHandler = async (req: Request, res: Response) => {
    ...
    res.clearCookie('jwt', { httpOnly: true, sameSite: 'none', secure: true, domain: "tobychat.netlify.app", path: "/" });
